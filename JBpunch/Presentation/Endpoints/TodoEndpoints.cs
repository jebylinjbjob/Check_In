...
public static class TodoEndpoints
{
    public static IEndpointRouteBuilder MapTodoEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        todos.MapGet("/", (ITodoService service) => service.GetAll()).WithName("GetTodos");

        todos
            .MapGet(
                "/{id:int}",
                Results<Ok<TodoDto>, NotFound> (int id, ITodoService service) =>
        ...
        todos
            .MapDelete(
                "/{id:int}",
                Results<NoContent, NotFound> (int id, ITodoService service) =>
